import "./main.js";
import { a as getHash, o as gotoBlock, r as bodyUnlock } from "./common.js";
import "./darklite.js";
/* empty css             */
/* empty css          */
/* empty css         */
...
function initSliders() {
	if (document.querySelector(".hero-block__slider")) new Swiper(".hero-block__slider", {
		modules: [Navigation],
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		...
		loop: true,
		navigation: {
			prevEl: ".hero-block__button--prev",
			nextEl: ".hero-block__button--next"
		},
		breakpoints: { 320: {
			slidesPerView: 1,
			spaceBetween: 40,
