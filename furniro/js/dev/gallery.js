...
function initSliders() {
	if (document.querySelector(".slider-rooms")) new Swiper(".slider-rooms", {
		modules: [
			Navigation,
			Pagination,
			Autoplay,
	...
	if (document.querySelector(".thumbs-images-product__slider")) swiperThumbs = new Swiper(".thumbs-images-product__slider", {
		modules: [
			Navigation,
			EffectFade,
			Thumb
	...
	if (document.querySelector(".main-images-product__slider")) new Swiper(".main-images-product__slider", {
		modules: [
			Navigation,
			Thumb,
			EffectFade
		...
		effect: "fade",
		navigation: {
			prevEl: ".thumbs-images-product__arrow--prev",
			nextEl: ".thumbs-images-product__arrow--next"
		},
		on: {}
	});
}
