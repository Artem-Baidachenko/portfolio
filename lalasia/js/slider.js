...
function initSliders() {
	...
	if (document.querySelector(".body-news__slider")) new Swiper(".body-news__slider", {
		modules: [Navigation, Pagination],
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		...
		loop: true,
		pagination: {
			el: ".body-news__pagination",
			clickable: true
		},
		navigation: {
			prevEl: ".body-news__button--prev",
			nextEl: ".body-news__button--next"
		},
		on: {}
	});
	if (document.querySelector(".body-article__slider")) new Swiper(".body-article__slider", {
		modules: [Navigation, Pagination],
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		...
		loop: true,
		pagination: {
			el: ".body-article__pagination",
			clickable: true
		},
		navigation: {
			prevEl: ".body-article__button--prev",
			nextEl: ".body-article__button--next"
		},
		on: {}
	});
}
